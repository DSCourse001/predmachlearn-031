...
```{r echo=FALSE,message=FALSE}
t1<-data.frame(Method=character(), Accuracy=character())

t1<-rbind(t1,data.frame(Method="K Nearest Neighbor", Accuracy=round(results1$overall[["Accuracy"]]*100,2)))
t1<-rbind(t1,data.frame(Method="Random Forest", Accuracy=round(results2$overall[["Accuracy"]]*100,2)))
